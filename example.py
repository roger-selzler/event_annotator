...
ea.config['log']=True
ea.add_label('HighPeaks',label_type='points',filename = 'D://RPeaksFilenameTst')
ea.add_label('LowPeaks',label_type='points',filename = 'D://RPeaksFilenameTst2') 
ea.add_label('Kevin',label_type='points',filename = 'D://RPeaksFilenameTst2') 
ea.add_label('GoodSegment',label_type='range',filename = 'D://goodSegments')
